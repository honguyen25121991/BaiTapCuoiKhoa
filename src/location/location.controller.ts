import { Controller, Get, Post, Body, Patch, Param, Delete, HttpException, Put, UseGuards, Headers, UseInterceptors, UploadedFile } from '@nestjs/common';
...
export class LocationController {
  ...
  // @UseGuards(AuthGuard('jwt'))
  @Post('/post-image-location/:id') postImage(
    @Param("id") id: string,
    ...
    try {
      return this.locationService.postImage(id, duong_dan, ten_vi_tri,
        tinh_thanh,
        quoc_gia,
      )
    } catch (error) {
